...
CREATE TABLE IF NOT EXISTS `m_kategori_hotspot` (
...
(1, 'admin', '$2a$12$wi4uN6hqkdNWX3O7OK/iu.DLqdEhJPgrNSexjf2CtkCf/EVAJIOtu', 'Admin'),
(2, 'user', '$2a$12$5qqJA8ZrvvjsrY2ASTQ6COQ4w1XNH4pb43OOZ/88V.qTuxTVLQLeS', 'User');
